...
export default {
  ...
  metaDesc:
    "Vi inviterer deg til å ta kontakt med oss for å lære mer om vårt utvidede tilbud innen solpaneler og hvordan du kan dra nytte av solenergi. Sammen kan vi bidra til en grønnere fremtid og en mer bærekraftig verden.",
  primary: "#FFC069",
  secondary: "#D3A45E",
  ...
  about: {
    ...
    p3: "Vi bruker kun solcellepaneler som er nøye utvalgt for optimal ytelse og lang levetid, og vi holder oss kontinuerlig oppdatert på ny teknologi. På den måten kan vi skreddersy et anlegg spesielt tilpasset dine behov, slik at du får maksimalt utbytte av investeringen din.",
    image2: "/lynelektro/omOssBilde.png",
    p4: "Vi er stolte av grundig håndverk og kjenner lokale forhold, klima og forskrifter ut og inn. Dermed monterer vi solpaneler med høy presisjon og kvalitet, slik at anlegget ditt kan stå i flere tiår. Med oss på laget får du dessuten personlig oppfølging – år etter år. Solmarkedet kan svinge, og bedrifter som kun driver med solceller risikerer å gå konkurs over tid. Vi, derimot, er et solid elektro-firma med flere bein å stå på. Det betyr at du kan stole på at vi fortsatt er her om 20–30 år, dersom noe skulle skje med anlegget ditt.",
  },

  advantage: {
    heroImage: "/lynelektro/fordelBilde.png",
    image: "/lynelektro/bilBilde.png",
  },
